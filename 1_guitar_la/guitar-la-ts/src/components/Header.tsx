...
function Header({ cart,removeFromCart,increaseQuantity,decreaseQuantity ,clearCart, cartTotal,isEmpty}: HeaderProps) {
          ...
          <nav className="col-md-6 a mt-5 d-flex align-items-start justify-content-end">
            ...
            >
              ...
              <div id="carrito" className="bg-white p-3">
                {isEmpty === 0 ? (<p className="text-center">Carrito Vacío</p>) : (<>
